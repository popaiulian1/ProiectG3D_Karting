...
public:
	...
	{
		return glm::normalize(glm::vec3(GetViewMatrix()[0][2], GetViewMatrix()[1][2], GetViewMatrix()[2][2]));
	}

	glm::vec3 GetUp() {
		return glm::normalize(glm::vec3(GetViewMatrix()[0][1], GetViewMatrix()[1][1], GetViewMatrix()[2][1]));
	}
